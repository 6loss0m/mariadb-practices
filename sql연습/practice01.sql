...
select last_name as '성', first_name as '이름'  from employees where emp_no=10944;
...
select count(distinct emp_no) as '직원 수' from salaries where to_date='9999-01-01';
...
select distinct title from titles order by length(title);
