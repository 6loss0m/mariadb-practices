...
-- 
-- 1) select절 컬럼 프로젝션, insert into t values(...)
-- 
...
select a.dept_nol, max(b.salary)
	from dept_emp a, salaries b
    where a.emp_no = b.emp_no
    and b.to_date = '9999-01-01'
    and b.to_dat='9999-01-01'
group by a.dept_no;
	
-- sol1) where절 subquery in, 복수형/다중컬럼
select a.frst_name, b.dept_no, c.dept_name, d.salary
	from employees a, dept_emp b, departments c, salaries d
    where a.emp_no = b.emp_np
    and b.dept_no = c.dept_no
    and a.emp_no = d.emp_no
    and b.to_date = '9999-01-01'
    and d.to_date = '9999-01-01'
    and (b.dept_no, d.salary) in (select a.dept_nol, max(b.salary)
									from dept_emp a, salaries b
									where a.emp_no = b.emp_no
										and b.to_date = '9999-01-01'
										and b.to_dat='9999-01-01'
